...
class SuperheatedSteam:
    def __init__(self, inputs: Dict[str, str] = None):
        ...
        self.P_6bar = {
            ...
            400: [0.51374, 2966.0, 3270.8, 7.7097],
        ...
        self.P_45bar = {
            257.44: [0.04406, 2599.7, 2798.0, 6.0198],
        ...
        self.P_80bar = {
            295.01: [0.023525, 2570.5, 2758.7, 5.7450],
        ...
        self.P_90bar = {
            303.35: [0.020489, 2558.5, 2742.9, 5.6791],
        ...
        self.P_100bar = {
            311.00: [0.018028, 2545.2, 2725.5, 5.6159],
        ...
        self.P_125bar = {
            327.81: [0.013496, 2505.6, 2674.3, 5.4638],
        ...
        self.P_150bar = {
            342.16: [0.010341, 2455.7, 2610.8, 5.3108], 
        ...
        self.P_175bar = {
            354.67: [0.007932, 2390.7, 2529.5, 5.1435], 
        ...
        self.P_200bar = {
            365.75: [0.005862, 2294.8, 2412.1, 4.9310], 
    ...
    def get_properties(self, pressure: float, temp: float):
        ...
        if p_low is None or p_high is None:
            raise ValueError(f"Pressure {pressure} bar out of range.")
    ...
    def _interp_within_table(self, table: Dict[float, List[float]], temp: float):
    ...
    def calculate(self) -> Dict[str, float]:
        try:
            ...
            return {
            "Pressure<br>(<em>P</em>, bar)": round(self.pressure, 2),
